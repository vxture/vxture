...
echo ""
echo "  D. 生成平台密钥与 env 文件："
echo "     cd $COMPOSE_DIR && bash scripts/setup-env.sh"
echo "     # 或手工创建 Postgres 密码文件："
echo "     echo 'your-strong-password' > $COMPOSE_DIR/secrets/pg-password"
echo "     chmod 600 $COMPOSE_DIR/secrets/pg-password"
echo ""
