 ...
 *   所有 LLM 调用通过 @vxture/ai-gateway-client/llm，禁止直接 import provider SDK（spec §11.3）。
 *
 * @author AI-Generated
 * @date 2026-04-30
 */
...
import {
  MessageRepository,
  type VelaMessageCreateInput,
  type VelaMessageRecord,
} from "../storage/message.repository";
import {
  SessionRepository,
  type VelaSessionRecord,
