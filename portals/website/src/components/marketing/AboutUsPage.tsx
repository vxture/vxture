    ...
    <div className='vx-page-surface'>
      ...
      <section id='about-positioning' className='vx-section-odd'>
        <div className='mx-auto max-w-7xl px-6 lg:px-8 xl:max-w-screen-2xl'>
          <div className='max-w-3xl'>
            <p className='text-sm font-semibold text-vx-brand-600 dark:text-vx-brand-300'>{t('positioning.eyebrow')}</p>
            <h2 className='font-display mt-2 text-3xl font-bold text-vx-gray-900 dark:text-vx-white'>{t('positioning.title')}</h2>
          ...
          <div className='mt-10 grid gap-4 md:grid-cols-3'>
            {pillars.map((item) => (
              ...
              >
                ...
                <h3 className='mt-5 text-base font-semibold text-vx-gray-900 dark:text-vx-white'>{item.title}</h3>
          ...
          <div className='mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-4'>
            {capabilities.map((item) => (
              <article
                ...
                className='rounded-lg border border-vx-gray-200 bg-vx-gray-50 p-5 dark:border-vx-gray-800 dark:bg-vx-gray-900'
              >
                <Icon name={item.icon} className='h-5 w-5 text-vx-brand-600 dark:text-vx-brand-300' />
                <h3 className='mt-4 text-base font-semibold text-vx-gray-900 dark:text-vx-white'>{item.title}</h3>
                <p className='mt-3 text-sm leading-6 text-vx-gray-600 dark:text-vx-gray-300'>
                  {item.description}
                </p>
              </article>
