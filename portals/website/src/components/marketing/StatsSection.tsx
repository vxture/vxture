  ...
  const stats = [
    {
      ...
      icon: <Icon name="building-library" className="w-16 h-16 text-vx-brand-400" />,
      ...
      <div className='relative z-10 h-full max-w-7xl xl:max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='flex items-center justify-between mb-16'>
          ...
          <div className='flex-1 text-center'>
            <h2 className='font-display text-3xl lg:text-4xl font-bold text-vx-brand-700 dark:text-vx-brand-200 mb-6'>服务的客户</h2>
