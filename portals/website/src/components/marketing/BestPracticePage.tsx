    ...
    <div className='vx-page-surface'>
              ...
              >
                <div className='vx-best-practice-media relative'>
                  ...
                  <div className='absolute bottom-0 p-5 text-vx-white'>
                    <p className='text-xs font-semibold text-vx-info-200'>{practice.customer}</p>
                  ...
                  <div className='mt-6 grid gap-4 xl:grid-cols-3'>
                    <div>
                      <div className='flex items-center gap-2 text-sm font-semibold text-vx-gray-900 dark:text-vx-white'>
                        <Icon name='building-library' className='h-4 w-4 text-vx-brand-600 dark:text-vx-brand-300' />
                    ...
                    <div>
                      <div className='flex items-center gap-2 text-sm font-semibold text-vx-gray-900 dark:text-vx-white'>
                        <Icon name='workflow' className='h-4 w-4 text-vx-brand-600 dark:text-vx-brand-300' />
                    ...
                    <div>
                      <div className='flex items-center gap-2 text-sm font-semibold text-vx-gray-900 dark:text-vx-white'>
                        <Icon name='chat-circle' className='h-4 w-4 text-vx-brand-600 dark:text-vx-brand-300' />
      ...
      <section className='vx-section-even'>
        <div className='mx-auto flex max-w-7xl flex-col gap-5 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8 xl:max-w-screen-2xl'>
          <div>
            <h2 className='font-display text-2xl font-bold text-vx-gray-900 dark:text-vx-white'>{t('page.cta.title')}</h2>
