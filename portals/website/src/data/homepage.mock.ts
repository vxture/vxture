...
export const MOCK_FEATURES_DATA: FeaturesData = {
  enabled: true,
  title: '核心功能',
...
export const MOCK_CASES_DATA: CasesData = {
  enabled: true,
  title: '成功案例',
...
export const MOCK_CTA_DATA: CTAData = {
  enabled: true,
  title: '准备好开始了吗？',
...
export const MOCK_SOLUTIONS_DATA: SolutionsData = {
  enabled: true,
  title: '解决方案',
