...
function TenantActionsMenu({ tenant }: { tenant: TenantOperationRecord }) {
      ...
      <ActionMenu
        ...
        items={[
          ...
          },
          {
            ...
            icon: (
              <Icon
                name={tenant.status === "suspended" ? "success" : "warning"}
                size="xs"
...
function TenantCards({ tenants }: { tenants: TenantOperationRecord[] }) {
  const router = useRouter();
