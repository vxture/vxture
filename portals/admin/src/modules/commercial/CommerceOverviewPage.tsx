      ...
      <div className="vx-commerce-plan-list">
        {snapshot.planRevenue.length ? (
          snapshot.planRevenue.map((plan) => (
            <article
              key={`${plan.planName}-${plan.tierName}`}
              className="vx-commerce-plan-row"
            >
              ...
              <span className="vx-commerce-plan-row__amounts">
                ...
                <span>
                  <strong>
                    {formatCurrency(plan.paidAmount, plan.currency)}
                  </strong>
                  <small>已收</small>
                </span>
                <span>
                  <strong>
                    {formatCurrency(plan.discountAmount, plan.currency)}
                  </strong>
                  <small>减免</small>
                </span>
              </span>
