    ...
    platformMetrics: [
      {
        ...
        tone: "blue",
        detail:
          "近30天新增租户 42，活跃租户 842；新增用户 1,280，活跃用户 18,960。",
      },
      {
        title: "订阅收入",
        value: "¥68.4万",
        ...
        tone: "green",
        detail:
          "近30天收入 684,000 元，累计确认收入 8,426,000 元；有效订阅 2,196。",
      },
      {
        title: "模型成本",
        value: "¥17.1万",
        ...
        tone: "amber",
        detail:
          "近30天模型与服务成本 171,000 元，累计成本 2,164,000 元，成本率 25.0%。",
      },
      {
        title: "服务质量",
        value: "4.7",
        ...
        tone: "cyan",
        detail:
          "近30天工单 326，已完成 248，进行中 54，搁置 24；服务评价 4.7 星。",
      },
    ],
    businessBands: [
      {
        ...
        metrics: [
          {
            ...
            secondary: "活跃 842",
            delta: "+42",
            detail: "租户总数 1,286，近30天新增 42，活跃租户 842。",
          },
          {
            label: "用户数量",
            value: "38,420",
            secondary: "活跃 18,960",
            delta: "+1,280",
            detail: "用户总数 38,420，近30天新增 1,280，活跃用户 18,960。",
          },
          {
            label: "Token消耗",
            value: "2.42B",
            secondary: "峰值 14 租户",
            delta: "+9.6%",
            detail: "近30天 Token 消耗 2.42B，峰值来自 14 个高频租户。",
            tone: "cyan",
          },
        ],
      },
        ...
        metrics: [
          {
            ...
            delta: "+186",
            detail:
              "订阅产品数量 2,418，新增 186；风险产品已合并到订阅健康状态中。",
          },
          {
            label: "订阅续费",
            value: "32",
            ...
            delta: "+4",
            detail:
              "近30天待跟进续费 32，较上一周期增加 4，其中 11 个存在付款或用量下降风险。",
            tone: "amber",
          },
          {
            label: "计量覆盖",
            ...
            delta: "+0.6%",
            detail:
              "计量覆盖 98.6%，较上一周期提升 0.6%，仍有 2 个低频产品待补齐。",
            tone: "green",
          },
        ],
      },
        ...
        metrics: [
          {
            ...
            secondary: "累计 ¥843万",
            delta: "+12.4%",
            detail: "近30天收入 684,000 元，累计确认收入 8,426,000 元。",
            tone: "green",
          },
          {
            label: "成本",
            ...
            secondary: "累计 ¥216万",
            delta: "+8.2%",
            detail: "近30天成本 171,000 元，累计成本 2,164,000 元。",
            tone: "amber",
          },
          {
            label: "毛利润",
            ...
            secondary: "累计 ¥626万",
            delta: "+13.8%",
            detail: "近30天毛利润 513,000 元，累计毛利润 6,262,000 元。",
            tone: "green",
          },
        ],
      },
    ...
    platformMetrics: [
      {
        ...
        tone: "blue",
        detail:
          "平台累计租户 1,286，累计新增 426；用户总数 38,420，活跃用户 28,600。",
      },
      {
        title: "订阅收入",
        value: "¥843万",
        ...
        delta: "+34.8%",
        tone: "green",
        detail: "累计确认收入 8,426,000 元；有效订阅 2,196。",
      },
      {
        title: "模型成本",
        value: "¥216万",
        ...
        delta: "+22.6%",
        tone: "amber",
        detail: "累计模型与服务成本 2,164,000 元，成本率 25.7%。",
      },
      {
        title: "服务质量",
        value: "4.6",
        ...
        tone: "cyan",
        detail:
          "累计工单 3,426，已完成 2,836，进行中 326，搁置 264；服务评价 4.6 星。",
      },
    ],
    businessBands: [
      {
        ...
        metrics: [
          {
            ...
            secondary: "活跃 1,024",
            delta: "+426",
            detail: "租户总数 1,286，累计新增 426，活跃租户 1,024。",
          },
          {
            label: "用户数量",
            value: "38,420",
            secondary: "活跃 28,600",
            delta: "+12,800",
            detail: "用户总数 38,420，累计新增 12,800，活跃用户 28,600。",
          },
          {
            label: "Token消耗",
            value: "42.6B",
            secondary: "峰值 64 租户",
            delta: "+24.8B",
            detail: "累计 Token 消耗 42.6B，年度新增 24.8B。",
            tone: "cyan",
          },
        ],
      },
        ...
        metrics: [
          {
            ...
            delta: "+1,240",
            detail:
              "累计订阅产品 2,418，累计新增 1,240；产品风险归入订阅健康。",
          },
          {
            label: "订阅续费",
            value: "386",
            ...
            delta: "+54",
            detail:
              "累计待跟进续费 386，新增 54，其中 86 个存在付款或用量下降风险。",
            tone: "amber",
          },
          {
            label: "计量覆盖",
            ...
            secondary: "待补齐 2",
            delta: "+3.8%",
            detail: "累计计量覆盖 98.6%，较年初提升 3.8%，2 个低频产品待补齐。",
            tone: "green",
          },
        ],
      },
        ...
        metrics: [
          {
            ...
            secondary: "本年 ¥843万",
            delta: "+34.8%",
            detail: "累计确认收入 8,426,000 元，本年收入 8,426,000 元。",
            tone: "green",
          },
          {
            label: "成本",
            ...
            secondary: "本年 ¥216万",
            delta: "+22.6%",
            detail: "累计成本 2,164,000 元，本年成本 2,164,000 元。",
            tone: "amber",
          },
          {
            label: "毛利润",
            ...
            secondary: "本年 ¥626万",
            delta: "+39.6%",
            detail: "累计毛利润 6,262,000 元，本年毛利润 6,262,000 元。",
            tone: "green",
          },
        ],
      },
    ...
    platformMetrics: [
      {
        ...
        tone: "blue",
        detail:
          "本月新增租户 38，活跃租户 818；新增用户 1,120，活跃用户 18,420。",
      },
      {
        title: "订阅收入",
        value: "¥64.2万",
        ...
        tone: "green",
        detail:
          "本月收入 642,000 元，累计确认收入 8,426,000 元；有效订阅 2,196。",
      },
      {
        title: "模型成本",
        value: "¥16.2万",
        ...
        delta: "+7.4%",
        tone: "amber",
        detail: "本月成本 162,000 元，累计成本 2,164,000 元，成本率 25.2%。",
      },
      {
        title: "服务质量",
        value: "4.7",
        ...
        tone: "cyan",
        detail:
          "本月工单 298，已完成 231，进行中 45，搁置 22；服务评价 4.7 星。",
      },
    ],
    businessBands: [
      {
        ...
        metrics: [
          {
            ...
            secondary: "活跃 818",
            delta: "+38",
            detail: "租户总数 1,286，本月新增 38，活跃租户 818。",
          },
          {
            label: "用户数量",
            value: "38,420",
            secondary: "活跃 18,420",
            delta: "+1,120",
            detail: "用户总数 38,420，本月新增 1,120，活跃用户 18,420。",
          },
          {
            label: "Token消耗",
            value: "2.18B",
            secondary: "峰值 13 租户",
            delta: "+8.4%",
            detail: "本月 Token 消耗 2.18B，峰值来自 13 个高频租户。",
            tone: "cyan",
          },
        ],
      },
        ...
        metrics: [
          {
            ...
            secondary: "有效 2,176",
            delta: "+162",
            detail: "本月订阅产品 2,392，新增 162；风险产品已并入订阅健康。",
          },
          {
            label: "订阅续费",
            value: "28",
            secondary: "预警 9",
            delta: "+3",
            detail: "本月待跟进续费 28，较上一周期增加 3，其中 9 个存在风险。",
            tone: "amber",
          },
          {
            label: "计量覆盖",
            ...
            delta: "+0.4%",
            detail:
              "本月计量覆盖 98.2%，较上一周期提升 0.4%，2 个低频产品待补齐。",
            tone: "green",
          },
        ],
      },
        ...
        metrics: [
          {
            ...
            secondary: "累计 ¥843万",
            delta: "+10.6%",
            detail: "本月收入 642,000 元，累计确认收入 8,426,000 元。",
            tone: "green",
          },
          {
            label: "成本",
            ...
            secondary: "累计 ¥216万",
            delta: "+7.4%",
            detail: "本月成本 162,000 元，累计成本 2,164,000 元。",
            tone: "amber",
          },
          {
            label: "毛利润",
            ...
            secondary: "累计 ¥626万",
            delta: "+11.8%",
            detail: "本月毛利润 480,000 元，累计毛利润 6,262,000 元。",
            tone: "green",
          },
        ],
      },
    ...
    platformMetrics: [
      {
        ...
        tone: "blue",
        detail:
          "本季度新增租户 126，活跃租户 902；新增用户 3,940，活跃用户 21,800。",
      },
      {
        title: "订阅收入",
        value: "¥196万",
        ...
        delta: "+18.2%",
        tone: "green",
        detail: "本季度收入 1,956,000 元，累计确认收入 8,426,000 元。",
      },
      {
        title: "模型成本",
        value: "¥48.6万",
        ...
        delta: "+11.5%",
        tone: "amber",
        detail: "本季度成本 486,000 元，累计成本 2,164,000 元，成本率 24.8%。",
      },
      {
        title: "服务质量",
        value: "4.6",
        ...
        tone: "cyan",
        detail:
          "本季度工单 884，已完成 702，进行中 124，搁置 58；服务评价 4.6 星。",
      },
    ],
    businessBands: [
      {
        ...
        metrics: [
          {
            ...
            secondary: "活跃 902",
            delta: "+126",
            detail: "租户总数 1,286，本季度新增 126，活跃租户 902。",
          },
          {
            label: "用户数量",
            value: "38,420",
            secondary: "活跃 21,800",
            delta: "+3,940",
            detail: "用户总数 38,420，本季度新增 3,940，活跃用户 21,800。",
          },
          {
            label: "Token消耗",
            value: "6.82B",
            secondary: "峰值 28 租户",
            delta: "+16.8%",
            detail: "本季度 Token 消耗 6.82B，峰值来自 28 个高频租户。",
            tone: "cyan",
          },
        ],
      },
        ...
        metrics: [
          {
            ...
            secondary: "有效 2,196",
            delta: "+512",
            detail: "本季度订阅产品 2,418，新增 512；产品风险归入订阅健康。",
          },
          {
            label: "订阅续费",
            value: "96",
            ...
            delta: "+12",
            detail:
              "本季度待跟进续费 96，较上一周期增加 12，其中 27 个存在付款或用量下降风险。",
            tone: "amber",
          },
          {
            label: "计量覆盖",
            ...
            delta: "+1.1%",
            detail:
              "本季度计量覆盖 98.6%，较上一周期提升 1.1%，2 个低频产品待补齐。",
            tone: "green",
          },
        ],
      },
      {
        ...
        metrics: [
          ...
          },
          {
            ...
            secondary: "累计 ¥216万",
            delta: "+11.5%",
            detail: "本季度成本 486,000 元，累计成本 2,164,000 元。",
            tone: "amber",
          },
          {
            label: "毛利润",
            ...
            secondary: "累计 ¥626万",
            delta: "+20.6%",
            detail: "本季度毛利润 1,470,000 元，累计毛利润 6,262,000 元。",
            tone: "green",
          },
        ],
      },
    ...
    platformMetrics: [
      {
        ...
        tone: "blue",
        detail:
          "本年度新增租户 426，活跃租户 1,024；新增用户 12,800，活跃用户 28,600。",
      },
      {
        title: "订阅收入",
        value: "¥843万",
        ...
        delta: "+34.8%",
        tone: "green",
        detail: "年度收入 8,426,000 元，累计确认收入 8,426,000 元。",
      },
      {
        title: "模型成本",
        value: "¥216万",
        ...
        delta: "+22.6%",
        tone: "amber",
        detail: "年度成本 2,164,000 元，成本率 25.7%。",
      },
      {
        title: "服务质量",
        value: "4.6",
        ...
        tone: "cyan",
        detail:
          "年度工单 3,426，已完成 2,836，进行中 326，搁置 264；服务评价 4.6 星。",
      },
    ],
    businessBands: [
      {
        ...
        metrics: [
          {
            ...
            secondary: "活跃 1,024",
            delta: "+426",
            detail: "租户总数 1,286，本年度新增 426，活跃租户 1,024。",
          },
          {
            label: "用户数量",
            value: "38,420",
            secondary: "活跃 28,600",
            delta: "+12,800",
            detail: "用户总数 38,420，本年度新增 12,800，活跃用户 28,600。",
          },
          {
            label: "Token消耗",
            value: "24.8B",
            secondary: "峰值 64 租户",
            delta: "+38.0%",
            detail: "年度 Token 消耗 24.8B，峰值来自 64 个高频租户。",
            tone: "cyan",
          },
        ],
      },
        ...
        metrics: [
          {
            ...
            secondary: "有效 2,196",
            delta: "+1,240",
            detail: "年度订阅产品 2,418，新增 1,240；产品风险归入订阅健康。",
          },
          {
            label: "订阅续费",
            value: "386",
            ...
            delta: "+54",
            detail:
              "年度待跟进续费 386，较上一周期增加 54，其中 86 个存在付款或用量下降风险。",
            tone: "amber",
          },
          {
            label: "计量覆盖",
            ...
            delta: "+3.8%",
            detail:
              "年度计量覆盖 98.6%，较上一周期提升 3.8%，2 个低频产品待补齐。",
            tone: "green",
          },
        ],
      },
      {
        ...
        metrics: [
          ...
          },
          {
            ...
            secondary: "累计 ¥216万",
            delta: "+22.6%",
            detail: "年度成本 2,164,000 元，累计成本 2,164,000 元。",
            tone: "amber",
          },
          {
            label: "毛利润",
            ...
            secondary: "累计 ¥626万",
            delta: "+39.6%",
            detail: "年度毛利润 6,262,000 元，累计毛利润 6,262,000 元。",
            tone: "green",
          },
        ],
      },
...
const ratingSnapshots = {
  ...
  PeriodKey,
  { service: string; product: string; sla: string }
>;
...
const customerLifecycleSnapshots = {
  recent30: {
    ...
    tenantChurn: "8",
    userChurn: "126",
    enterpriseTenants: "186",
    activeEnterpriseTenants: "142",
    newEnterpriseTenants: "+9",
    enterpriseChurn: "2",
  },
  total: {
    paidTenants: "684",
    tenantChurn: "72",
    userChurn: "1,860",
    enterpriseTenants: "248",
    activeEnterpriseTenants: "196",
    newEnterpriseTenants: "+86",
    enterpriseChurn: "18",
  },
  year: {
    paidTenants: "684",
  ...
  quarter: {
    ...
    tenantChurn: "18",
    userChurn: "386",
    enterpriseTenants: "224",
    activeEnterpriseTenants: "172",
    newEnterpriseTenants: "+21",
    enterpriseChurn: "4",
  },
  month: {
    paidTenants: "612",
    ...
    userChurn: "98",
    enterpriseTenants: "186",
    activeEnterpriseTenants: "138",
    newEnterpriseTenants: "+7",
    enterpriseChurn: "1",
  },
} satisfies Record<
  PeriodKey,
...
const subscriptionLifecycleSnapshots = {
  recent30: {
    paidSubscriptions: "1,824",
    conversionRate: "72%",
    trialSubscriptions: "386",
    newPaidSubscriptions: "+118",
    cancelledSubscriptions: "14",
    renewalDue: "32",
    renewalRisk: "11",
    overdueSubscriptions: "4",
  },
  total: {
    paidSubscriptions: "1,924",
    conversionRate: "74%",
    trialSubscriptions: "494",
    newPaidSubscriptions: "+620",
    cancelledSubscriptions: "126",
    renewalDue: "386",
    renewalRisk: "86",
    overdueSubscriptions: "28",
  },
  year: {
    paidSubscriptions: "1,924",
    conversionRate: "74%",
  ...
  quarter: {
    paidSubscriptions: "1,872",
    conversionRate: "73%",
    trialSubscriptions: "546",
    newPaidSubscriptions: "+264",
    cancelledSubscriptions: "34",
    renewalDue: "96",
    renewalRisk: "27",
    overdueSubscriptions: "10",
  },
  month: {
    paidSubscriptions: "1,806",
    conversionRate: "71%",
    trialSubscriptions: "586",
    newPaidSubscriptions: "+102",
...
const revenueValidationSnapshots = {
  recent30: {
    actualRevenue: "¥58.2万",
    nominalRevenue: "¥74.4万",
    revenueQualityRate: "78%",
    discountAmount: "¥16.2万",
    newPaidRevenue: "+¥9.6万",
    collectionRate: "91%",
    collectedAmount: "¥61.6万",
    receivableAmount: "¥6.8万",
    overdueAmount: "¥1.8万",
  },
  total: {
    actualRevenue: "¥716万",
    ...
    newPaidRevenue: "+¥124万",
    collectionRate: "92%",
    collectedAmount: "¥758万",
    receivableAmount: "¥84.2万",
    overdueAmount: "¥12.6万",
  },
  year: {
    actualRevenue: "¥716万",
  ...
  quarter: {
    actualRevenue: "¥167万",
    nominalRevenue: "¥210万",
    revenueQualityRate: "80%",
    discountAmount: "¥43万",
    newPaidRevenue: "+¥38.6万",
    collectionRate: "90%",
    collectedAmount: "¥176万",
    receivableAmount: "¥19.6万",
    overdueAmount: "¥4.2万",
  },
  month: {
    actualRevenue: "¥54.6万",
    nominalRevenue: "¥69.4万",
    revenueQualityRate: "79%",
    discountAmount: "¥14.8万",
    newPaidRevenue: "+¥8.2万",
    collectionRate: "92%",
    collectedAmount: "¥59万",
    receivableAmount: "¥6.2万",
    overdueAmount: "¥1.4万",
  },
} satisfies Record<
  PeriodKey,
...
function productTierPriceLabel(
  tier: ProductSolutionTier,
  plan: ProductPlanRecord | null,
  locale: Locale,
) {
...
function stableTokenFallback(model: AiModelRecord) {
  const seed = [...model.modelCode].reduce(
...
function serviceMetricsFor(period: PeriodKey) {
  ...
  return [
    {
      label: "工单总数",
      value: ticketTotal.toLocaleString("en-US"),
      detail: `${label}累计工单 ${ticketTotal.toLocaleString("en-US")}。`,
      tone: "blue",
      icon: "chat-circle",
    },
    {
      ...
      detail: `${label}已完成 ${completed.toLocaleString("en-US")}，完成率 76.1%。`,
      tone: "green",
      icon: "success",
    },
    {
      label: "进行中",
      value: processing.toLocaleString("en-US"),
      detail: `${label}进行中 ${processing.toLocaleString("en-US")}，平均响应 18 分钟。`,
      tone: "cyan",
      icon: "clock",
    },
    {
      label: "已搁置",
      value: paused.toLocaleString("en-US"),
      detail: `${label}已搁置 ${paused.toLocaleString("en-US")}，主要等待客户或产品确认。`,
      tone: "amber",
      icon: "warning",
    },
  ...
  return [
    {
      ...
      detail: `${label}服务评价 ${snapshot.service} 星。`,
      tone: "green",
      icon: "star",
      display: "stars",
    },
    {
      ...
      detail: `${label}产品评价 ${snapshot.product} 星。`,
      tone: "blue",
      icon: "medal",
      display: "stars",
    },
    {
      label: "SLA",
      value: snapshot.sla,
      detail: `${label}服务 SLA 达成率 ${snapshot.sla}。`,
      tone: "cyan",
      icon: "shield-check",
      display: "text",
    },
  ...
  return [
    {
      ...
      title: "活跃客户",
      value:
        compactMetricValue(tenantMetric?.secondary, ["活跃"]) ||
        tenantMetric?.value ||
        "—",
      ...
      tags: [
        createOverviewPulseTag(
          tenantMetric?.delta ?? "—",
          "新增",
          displayDeltaTone(tenantMetric?.delta),
        ),
      ],
    },
    {
      ...
      tags: [
        createOverviewPulseTag(
          revenueMetric?.delta ?? "—",
          undefined,
          displayDeltaTone(revenueMetric?.delta),
        ),
      ],
    },
    {
      ...
      tags: [
        createOverviewPulseTag(
          tokenMetric?.delta ?? "—",
          undefined,
          displayDeltaTone(tokenMetric?.delta),
        ),
      ],
    },
    {
      ...
      tags: [
        {
          label: "阻塞工单",
          value: extractServiceBlockedCount(serviceMetric.detail),
        },
      ],
    },
  ...
  if (panel.id === "tenantScale") {
    ...
    return [
      ...
      },
      {
        ...
        detail:
          "私域沉淀的高价值客户数量，包含企业客户、重点个人客户和行业项目客户，用于观察高价值客户池的增长与留存。",
        tone: "blue",
    ...
    return [
      {
        ...
        detail:
          "有效订阅指当前处于试用、已付费或合同服务期内，仍能产生产品权益的订阅实例。",
        tone: "blue",
        icon: "database",
        minor: [
          { label: "新增", value: first?.delta ?? "—" },
          {
            label: "取消",
            value: lifecycle.cancelledSubscriptions,
            tone: "rose",
          },
        ],
      },
      {
        ...
        detail:
          "转化率按付费订阅 /（试用订阅 + 付费订阅）计算，用于观察试用或免费方案转为付费方案的效率。",
        tone: "blue",
        icon: "chart-bar",
        minor: [
      ...
      },
      {
        ...
        minor: [
          ...
          {
            label: "逾期",
            value: lifecycle.overdueSubscriptions,
            tone: "rose",
          },
        ],
      },
  ...
  return [
    {
      ...
      minor: [
        {
          label: "新增",
          value: formatAdminCompactCurrencyDelta(
            revenue.newPaidRevenue,
            locale,
          ),
        },
        {
          label: financeSecondaryLabel(panel.period),
          value: formatAdminCompactCurrencyInput(
            compactMetricValue(first?.secondary, ["累计", "本年"]),
            locale,
          ),
        },
      ],
    },
    {
      ...
      detail:
        "收入质量按实际收入 / 名义收入计算。名义收入包含代金券、折扣抵扣或账面权益，实际收入更接近真实商业验证。",
      tone: "blue",
      icon: "database",
      minor: [
        {
    ...
    },
    {
      ...
      valueTag: formatAdminCompactCurrencyInput(
        revenue.collectedAmount,
        locale,
      ),
      detail:
        "回款健康用于观察确认收入是否能按账期变成现金，逾期金额越高越需要运营或财务跟进。",
      tone: "amber",
      icon: "shield-check",
      minor: [
        {
        ...
        {
          label: "逾期",
          value: formatAdminCompactCurrencyInput(revenue.overdueAmount, locale),
          tone: "rose",
        },
      ],
    },
...
function BusinessPanel({
  ...
  return (
    <section
      className={`admin-overview-business-panel ${metricToneClass(panel.band.tone)}`}
...
export default function AdminOverviewPage() {
  ...
  const productRankings = useMemo(() => {
    const productNameByCode = new Map(
      releases.map((release) => [release.productCode, release.productName]),
    );
    ...
    const productRows = productOperations.map((item) => {
      ...
      return {
        ...
        name:
          productNameByCode.get(operation.productCode) ?? operation.productCode,
        meta: "产品能力",
    ...
    const solutionRows = solutions.map((solution) => ({
      ...
      subscriptions: scalePeriodValue(
        solution.subscriptionCount,
        productPeriod,
      ),
      monthlyNew: scalePeriodValue(
        Math.max(1, Math.round(solution.subscriptionCount * 0.18)),
        productPeriod,
      ),
    }));
    const tierRows = solutions.flatMap((solution) => {
      const activeTiers = solution.tiers.filter(
      ...
      return scopedTiers.map((tier, index) => {
        const weight =
          tier.tierCode === "enterprise" || tier.tierCode === "custom"
            ? 1.25
            : tier.tierCode === "pro"
              ? 1.05
              : 0.82;
        ...
        return {
          ...
          subscriptions: scalePeriodValue(
            Math.max(
              1,
              Math.round((solution.subscriptionCount / tierCount) * weight),
            ),
            productPeriod,
          ),
          monthlyNew: scalePeriodValue(
            Math.max(
              1,
              Math.round(
                (solution.subscriptionCount / tierCount) * 0.12 + index,
              ),
            ),
            productPeriod,
          ),
          priceTag: productTierPriceLabel(
            tier,
            plansByCode.get(tierPlanCodeMap[tier.tierCode]) ?? null,
            locale,
          ),
        };
      });
  ...
  const capabilityMetrics = useMemo(() => {
    ...
    const totalTokenCalls = models.reduce(
      (total, model) => total + modelTokenCalls(model, modelPeriod),
      0,
    );
    ...
    return [
      {
        ...
        rankStyle: "number",
        rows: (serviceRows.length ? serviceRows : fallbackServiceRows)
          .sort(
            (left, right) =>
  ...
  const serviceMetrics = useMemo(
    () => serviceMetricsFor(servicePeriod),
    [servicePeriod],
  );
  const ratingMetrics = useMemo(
    () => ratingMetricsFor(servicePeriod),
    [servicePeriod],
  );
    ...
    <div className="vx-page-stack admin-overview">
      ...
      <section className="admin-overview-section" aria-label="经营指标">
        <OverviewHeading
          icon="chart-bar"
          title="经营指标"
          description={`${overviewSnapshots[businessPeriod].label}观察客户增长、订阅转化和收入验证，优先看运营动作是否带来真实使用与商业信号。`}
