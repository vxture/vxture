...
const DEFAULT_PROFILE_AVATAR_ONLINE_SRC =
  "/assets/icon/avatar-default-online.png";
...
export function ProfilePage() {
  ...
  useEffect(() => {
    ...
    try {
      const stored = window.localStorage.getItem(
        connectedAccountsStorageKey(profile.id),
      );
      if (!stored) {
        setConnectedAccounts(DEFAULT_CONNECTED_ACCOUNTS);
        return;
      ...
      const byProvider = new Map(
        parsed.map((account) => [account.provider, account]),
      );
  ...
  function bindConnectedAccount(provider: ConnectedAccountProvider) {
    ...
    setFeedback({
      tone: "success",
      key: "feedback.connectedAccountBound",
      values: { provider: t(`connectedAccounts.providers.${provider}.name`) },
    });
  }
  ...
  const avatarStatus = profile?.avatarUrl
    ? t("summary.customAvatar")
    : t("summary.defaultAvatar");
  ...
  const connectedAccountCount = connectedAccounts.filter(
  ...
  const identityFields: ProfileField[] = [
    ...
    },
    {
      ...
      value: loading ? loadingText : username,
    },
    {
      icon: "medal",
      label: t("fields.headline"),
      value: loading ? loadingText : headline,
    },
    {
      icon: "chat-circle",
      label: t("fields.bio"),
      value: loading ? loadingText : bio,
      multiline: true,
    },
  ];
  ...
  const contactFields: ProfileField[] = [
    {
      ...
      value: loading ? loadingText : email,
    },
    {
      icon: "phone",
      label: t("fields.phone"),
      value: loading ? loadingText : phone,
    },
    {
      icon: "clock",
      label: t("fields.timezone"),
      value: loading ? loadingText : timezone,
    },
    {
      icon: "globe",
      label: t("fields.language"),
      value: loading ? loadingText : language,
    },
  ];
    ...
    <div className="vx-page-stack vx-profile-page vx-account-profile-page">
      ...
      <div className="vx-account-profile-layout">
        <aside className="vx-account-profile-identity">
          <section className="vx-account-profile-avatar-card">
            ...
            >
              <Avatar
                className="vx-account-profile-avatar"
                role="img"
                aria-label={t("avatar.alt", { name: displayName })}
            ...
            <div className="vx-account-profile-avatar-card__copy">
              ...
              <span>{username}</span>
              <Badge className="vx-account-profile-avatar-card__badge">
                {roleLabel}
              </Badge>
            </div>
            ...
            <div className="vx-account-profile-avatar-card__actions">
              ...
              <ActionButton
                ...
                disabled={submitting || !profile?.avatarUrl}
              >
          ...
          <section className="vx-account-profile-section">
            ...
            <div className="vx-account-connected-list">
              {connectedAccounts.map((account) => {
                ...
                const connectedAt = formatProfileDate(
                  account.connectedAt,
                  locale,
                  empty,
                );
                  ...
                  >
                    ...
                    >
                      {account.provider === "wechat" ? (
                        <Icon name="wechat" size="xs" fallback="placeholder" />
                      ) : (
                    ...
                    <div className="vx-account-connected-meta">
                      ...
                      <strong title={account.accountName || accountId}>
                        {account.connected
                      ...
                      {account.connected ? (
                        <>
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              bindConnectedAccount(account.provider)
                            }
                          >
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => openUnbindConnectedAccount(account)}
                          >
                        ...
                        <Button
                          size="sm"
                          onClick={() => bindConnectedAccount(account.provider)}
                          disabled={!account.enabled}
                        >
                          {account.enabled
                            ? t("connectedAccounts.actions.bind")
                            : t("connectedAccounts.status.unavailable")}
                        </Button>
                      )}
                    </div>
                  </div>
      ...
      {profileDialogOpen ? (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label={t("dialogs.profile.title")}
        >
          <div
          ...
          >
            ...
            <div className="vx-account-profile-dialog-grid">
              <div className="vx-account-avatar-editor">
                <Avatar
                  className="vx-account-avatar-editor__preview"
                  role="img"
                  aria-label={t("avatar.previewAlt", { name: previewName })}
                  style={avatarStyle(previewAvatar)}
                >
                  <span className="vx-account-profile-avatar__label">
                    {previewName}
                  </span>
                ...
                <div>
                  ...
                  <span>
                    {profileForm.avatarUrl
                      ? t("avatar.customPreview")
                      : t("avatar.defaultPreview")}
                  </span>
                </div>
              </div>
      ...
      {contactDialogOpen ? (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label={t("dialogs.contact.title")}
        >
          <div
            className="vx-profile-dialog__backdrop"
