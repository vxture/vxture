/**
 * ruinagent.aggregator.ts - Ruin Agent upstream aggregator
 * @package @vxture/bff-ruinagent
 *
 * Description: Calls the paired agent-server/ruinagent internal API and reshapes
...
export class RuinAgentBffError extends Error {
  constructor(
    message: string,
    readonly statusCode: number,
  ) {
    super(message);
    this.name = 'RuinAgentBffError';
  }
}

@Injectable()
export class RuinAgentAggregator {
