...
export default function ThemeLanguageTestPage() {
  // 获取全局主题和语言状态及操作方法
  const { theme, toggleTheme, locale, setLocale } = useGlobal();
  ...
  // 获取当前语言对应的内容
  const content = testContent[locale];
  ...
  // 避免 hydration mismatch：首次渲染时不显示依赖客户端状态的内容
        ...
        <div className='container flex justify-between items-center'>
          ...
          <div className='flex items-center gap-4'>
            ...
            <div className='flex items-center gap-2'>
              ...
              {/* 仅在客户端挂载后再渲染主题名称，避免 hydration mismatch */}
              {mounted && (
