...
// 每个 section 高度为屏幕高度，带有 'snap-target' 类，支持临近吸附
...
export default function ProductDetailPartOne() {
  return (
    <>
      ...
      <div
        id='target-1' // 唯一 ID
        className='snap-target bg-gray-200 px-8 flex items-center justify-center' // 吸附类、屏幕高度、居中布局、调试边框
      >
        <div className='text-center'>
          <h2 className='text-3xl font-bold text-blue-600'>特定吸附区域1</h2>
          <p className='mt-4 text-gray-600'>
            带.snap-target类，滚动到距离视口120px内会自动吸附到顶部。
          </p>
        </div>
      </div>
      ...
      <div
        id='target-2' // 唯一 ID
        className='snap-target bg-blue-200 px-8 flex items-center justify-center' // 吸附类、屏幕高度、居中布局、调试边框
      >
        <div className='text-center'>
      ...
      <div
        id='target-3' // 唯一 ID
        className='snap-target bg-gray-200 px-8 flex items-center justify-center' // 吸附类、屏幕高度、调试边框
      >
        <div className='text-center'>
          <h2 className='text-3xl font-bold'>特定吸附区域3</h2>
          <p className='mt-4 text-gray-600'>继续滚动，下一个带.snap-target的元素会触发吸附。</p>
        </div>
      </div>
      ...
      >
        <div className='text-center'>
          ...
          <p className='mt-4 text-gray-600'>同样带.snap-target类，仅该类元素会触发吸附。</p>
        </div>
      </div>
    </>
  );
