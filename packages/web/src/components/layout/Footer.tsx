 ...
 *
 * 功能：
 * - 网站全局底部信息栏，包含品牌、联系方式、备案号、社交媒体等
 *
 * 用途：
 * - 作为所有页面的主底部栏，统一品牌形象与合规信息
 *
 * 依赖/调用关系：
 * - 依赖 React、react-icons
 ...
 * @see Header.tsx
 * @tags footer, layout, copyright, component
 * @example
 *   <Footer />
 * @remarks
