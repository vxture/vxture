      ...
      <div className="max-w-7xl xl:max-w-screen-2xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-2xl font-bold">vxture</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              专注于数据智能领域，为企业提供专业的数据分析、机器学习和智能决策解决方案。
            </p>
          ...
          {/* 公司信息 */}
          <div>
            <h3 className="text-lg font-semibold mb-6">公司信息</h3>
            <ul className="space-y-3">
              <li>
                <a
                  href="#"
        ...
        <div className="py-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="flex flex-col md:flex-row md:items-center md:space-x-6 space-y-2 md:space-y-0 text-sm text-gray-400">
            <p>&copy; 2024 vxture 数聚未来科技有限公司. 保留所有权利.</p>
