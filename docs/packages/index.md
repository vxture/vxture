...
| 文件                           | 包名                        | 职责摘要                                                   |
| ------------------------------ | --------------------------- | ---------------------------------------------------------- |
| [`ai/ai-sdk.md`](ai/ai-sdk.md) | `@vxture/ai-gateway-client` | AI Gateway HTTP 客户端（LLM / Embedding / RAG / Workflow） |
...
- **禁止**：直接签发 JWT / 跨 BFF 代码引用 / 引入 `@vxture/ai-gateway-client` / BFF 层实现业务逻辑
