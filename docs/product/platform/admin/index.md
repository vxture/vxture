...
> BFF：[`docs/packages/bff/admin-bff.md`](../../../packages/bff/admin-bff.md)
...
- 权限判断使用菜单 `code` 字段，见 [`admin-menu.md`](admin-menu.md)
...
| 文档 | 内容 |
|------|------|
| [`admin-menu.md`](admin-menu.md) | 双域完整菜单规格（path / code / i18n / status / TS 初始化数据） |
| [`admin-directory-structure.md`](admin-directory-structure.md) | 路由 → 模块索引 / 架构边界注意事项 |
| [`admin-platform-governance-db-plan.md`](admin-platform-governance-db-plan.md) | 平台治理记录表设计草案 |
| [`admin-ticket-todo-db-plan.md`](admin-ticket-todo-db-plan.md) | 工单与运营待办 DB 设计 |
| [`dingtalk-auth-config.md`](dingtalk-auth-config.md) | 钉钉 OAuth 配置（仅用于 website-bff，admin 禁用） |
